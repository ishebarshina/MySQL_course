...
CREATE TABLE `communities_users` (
  ...
  CONSTRAINT `fk_member_id` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
...
CREATE TABLE `friendship` (
  ...
  CONSTRAINT `fk_current_user_id` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Справочная таблица с типами лайков';
...
CREATE TABLE `likes` (
  ...
  KEY `fk_likes_user_id` (`from_user_id`),
  ...
  CONSTRAINT `fk_likes_user_id` FOREIGN KEY (`from_user_id`) REFERENCES `users` (`id`)
...
CREATE TABLE `media_types` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Тип медиа контента';
...
CREATE TABLE `messages` (
  ...
  KEY `fk_reciever_id` (`reciever_id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Посты пользователей и групп';
